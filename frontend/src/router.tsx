    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: '/admin/clients',
            element: <RoleGuard roles={['PLATFORM_ADMIN']}><ClientList /></RoleGuard>,
          },
          {
            path: '/admin/clients/:id',
            element: <RoleGuard roles={['PLATFORM_ADMIN']}><ClientDetail /></RoleGuard>,
          },
          {
            path: '/admin/dynata',
            element: <RoleGuard roles={['PLATFORM_ADMIN']}><DynataMonitor /></RoleGuard>,
          },
          {
            path: '/admin/system',
            element: <RoleGuard roles={['PLATFORM_ADMIN']}><SystemHealth /></RoleGuard>,
          },
        ],
      },
    ],
