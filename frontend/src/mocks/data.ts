...
export const MOCK_SURVEYS: Survey[] = [
  { id: '1', clientId: 'c1', title: 'Q2 Brand Perception Study',        description: '18–35 US audience',       status: 'LIVE',      receivedResponseCount: 312, targetResponseCount: 500, country: 'US', createdAt: '2026-04-02T09:00:00Z', publishedAt: '2026-04-02T11:00:00Z', dynataProjectId: 'DYN-98765' },
  { id: '2', clientId: 'c1', title: "Product Satisfaction – Spring '26", description: 'Post-purchase feedback',  status: 'LIVE',      receivedResponseCount: 88,  targetResponseCount: 200, country: 'GB', createdAt: '2026-04-10T09:00:00Z', publishedAt: '2026-04-10T10:00:00Z', dynataProjectId: 'DYN-98812' },
  { id: '3', clientId: 'c1', title: 'Competitor Awareness Survey',       description: 'General consumer panel', status: 'DRAFT',     receivedResponseCount: 0,   targetResponseCount: 300, country: 'US', createdAt: '2026-04-18T09:00:00Z' },
  { id: '4', clientId: 'c1', title: 'Ad Recall Test – Campaign V2',      description: 'Exposed vs. control',    status: 'PAUSED',    receivedResponseCount: 145, targetResponseCount: 400, country: 'CA', createdAt: '2026-03-15T09:00:00Z', publishedAt: '2026-03-15T12:00:00Z', dynataProjectId: 'DYN-97701' },
  { id: '5', clientId: 'c1', title: 'NPS Benchmark 2025',                description: 'Annual loyalty tracker', status: 'COMPLETED', receivedResponseCount: 600, targetResponseCount: 600, country: 'AU', createdAt: '2026-01-05T09:00:00Z', publishedAt: '2026-01-05T10:00:00Z', dynataProjectId: 'DYN-95500' },
];
